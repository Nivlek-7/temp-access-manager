...
public class AcessoController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Acesso concedido",
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Acesso revogado",
    ...
    @GetMapping("/usuario")
    @Operation(summary = "Lista os acessos do usuário autenticado",
